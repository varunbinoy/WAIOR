...
def main():
    ...
    # Objective: maximize total sessions across all sections
    total_sessions = model.NewIntVar(0, len(section_ids) * len(slot_ids), "total_sessions")
    ...
    print("\nSolving (floor=18, maximize total up to 20)...")
    ...
    # Count how many sections hit 20, 19, 18
    dist = {18: 0, 19: 0, 20: 0}
    for sec in section_ids:
    ...
    out_path = OUTPUT_DIR / "section_sessions_floor18_max.csv"
